    ...
    <body>
        ...
        <div class="mainbody-section text-center">
            <div class="container">
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group" id="btnLogin" style="display:inline;">
                        ...
                        <div class="form-group" id="btnLogout" style="display:none;">
                            <div class="menu-item blue">
                        ...
                        <div class="form-group" id="btnPacientes" style="display:none">    
                        ...
                        <div class="form-group" id="btnControl" style="display:none">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6" id="btnConsulta" style="display:none">
                            ...
                            <div class="col-md-6" id="btnTips" style="display:none">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group" id="btnRegistrate" style="display:inline">
                            <div class="menu-item light-red">
                        ...
                        <div class="form-group" id="btnContactanos" style="display:none">
                        ...
                        <div class="form-group" id="btnAcerca" style="display:none">
                            <div class="menu-item blue">
...
<<<<<<< HEAD
                    <div class="row" id="divLogin">
						...
						<label>USUARIO:                                                
						<input type="text" class="form-control" placeholder="Users *" id="txtUser" required data-validation-required-message="Inserte el Usuario"></label></br>
						<label>PASSWORD:                                                
						<input type="password" class="form-control" placeholder="Password *" id="txtPassword" required data-validation-required-message="Inserte la Contraseña"></label>                                                 
                                            </div>
                            ...
                            <form id="PacienteForm" novalidate>
                                <div class="row" style="margin-bottom: 15px;">
                                    <fieldset class="grupo">
                                        ...
                                        <div class="form-group fila">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" placeholder="Número de identificación *" id="txtIdentificacionPac" required data-validation-required-message="Por favor ingresa tu apellido.">
                                                <p class="help-block text-danger"></p>
                                            </div>
                                        </div>
                                        <div class="form-group fila" style="height: 109px;">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <input type="date" class="form-control" id="dtpFecNacPac" required data-validation-required-message="Por favor ingresa tu fecha de nacimiento.">
                                                    <p class="help-block text-danger"></p>
                                                </div>
                                                <div class="form-group">
                                                    <input type="email" class="form-control" placeholder="Email *" id="txtEmailPac" required data-validation-required-message="Por favor ingresa tu email.">
                                                    <p class="help-block text-danger"></p>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="form-group fila">
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" placeholder="Usuario *" id="txtUserPac" required data-validation-required-message="Por favor ingresa tu usuario.">
                                                <p class="help-block text-danger"></p>
                                            </div>
                                            <div class="col-md-6">
                                                <input type="password" class="form-control" placeholder="Contraseña *" id="txtPasswordPac" required data-validation-required-message="Por favor ingresa tu contraseña.">
                                                <p class="help-block text-danger"></p>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <fieldset class="grupo">
                                        ...
                                        <div class="form-group fila">
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" placeholder="Nombres *" id="txtNombreCon" required data-validation-required-message="Por favor ingresa el nombre de tu contacto.">
                                                <p class="help-block text-danger"></p>
                                            </div>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" placeholder="Apellidos *" id="txtApellidoCon" required data-validation-required-message="Por favor ingresa el apellido de tu contacto.">
                                                <p class="help-block text-danger"></p>
                                            </div>
                                        </div>
                                        <div class="form-group fila">
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" placeholder="Celular *" id="txtCelularCon" required data-validation-required-message="Por favor ingresa el celular de tu contacto.">
                                                <p class="help-block text-danger"></p>
                                            </div>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" placeholder="Email *" id="txtEmailCon" required data-validation-required-message="Por favor ingresa el email de tu contacto.">
                                                <p class="help-block text-danger"></p>
                                            </div>
                                        </div>
                            ...
                            <form id="PacienteForm" novalidate>
                                <div class="row" style="margin-bottom: 15px;">
                                    <fieldset class="grupo">
                                        ...
                                        <div class="form-group fila">
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" placeholder="Nombres *" id="txtNombreMed" required data-validation-required-message="Por favor ingresa tu nombre.">
                                                <p class="help-block text-danger"></p>
                                            </div>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" placeholder="Apellidos *" id="txtApellidoMed" required data-validation-required-message="Por favor ingresa tu apellido.">
                                                <p class="help-block text-danger"></p>
                                            </div>
                                        </div>
                                        <div class="form-group fila">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" placeholder="Número de identificación *" id="txtIdentificacionMed" required data-validation-required-message="Por favor ingresa tu apellido.">
                                                <p class="help-block text-danger"></p>
                                            </div>
                                        </div>
                                        <div class="form-group fila" style="height: 109px;">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <input type="date" class="form-control" id="dtpFecNacMed" required data-validation-required-message="Por favor ingresa tu fecha de nacimiento.">
                                                    <p class="help-block text-danger"></p>
                                                </div>
                                                <div class="form-group">
                                                    <input type="email" class="form-control" placeholder="Email *" id="txtEmailMed" required data-validation-required-message="Por favor ingresa tu email.">
                                                    <p class="help-block text-danger"></p>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="form-group fila">
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" placeholder="Usuario *" id="txtUserMed" required data-validation-required-message="Por favor ingresa tu usuario.">
                                                <p class="help-block text-danger"></p>
                                            </div>
                                            <div class="col-md-6">
                                                <input type="password" class="form-control" placeholder="Contraseña *" id="txtPasswordMed" required data-validation-required-message="Por favor ingresa tu contraseña.">
                                                <p class="help-block text-danger"></p>
                                            </div>
                                        </div>
                                ...
                                <div class="row" style="margin-bottom: 15px;">
                                    <fieldset class="grupo">
                                        ...
                                        <div class="form-group fila">
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" placeholder="Universidad *" id="txtUniversidadMed" required data-validation-required-message="Por favor ingresa el nombre de tu contacto.">
                                                <p class="help-block text-danger"></p>
                                            </div>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" placeholder="Título obtenido *" id="txtTituloMed" required data-validation-required-message="Por favor ingresa el apellido de tu contacto.">
                                                <p class="help-block text-danger"></p>
                                            </div>
                                        </div>
                                        <div class="form-group fila">
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" placeholder="Año de graduación *" id="txtAnioGraduacion" required data-validation-required-message="Por favor ingresa el celular de tu contacto.">
                                                <p class="help-block text-danger"></p>
                                            </div>
                                        </div>
