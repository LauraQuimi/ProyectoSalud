...
// $DirectorioCollectorObj->insertDirectorio($nombre_contacto, $apellido_contacto,$celular_contacto, $email_contacto, $id_usuario, $id_tipo_relacion);
//print_r($DirectorioCollectorObj);
?>
<html>
   <head>
   <h3>Insercion ok</h3>
